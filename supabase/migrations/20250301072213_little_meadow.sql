...
ALTER TABLE audits DROP CONSTRAINT IF EXISTS audit_reference_number_unique;
...
BEGIN
  ...
  -- Lock the audits table to prevent concurrent access
  LOCK TABLE audits IN SHARE UPDATE EXCLUSIVE MODE;
