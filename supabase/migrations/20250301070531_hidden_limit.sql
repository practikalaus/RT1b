-- Add audit_price column to customers table if it doesn't exist
ALTER TABLE customers
  ADD COLUMN IF NOT EXISTS audit_price DECIMAL(10,2);

-- Create a sequence for audit reference numbers
...
-- Create or replace the trigger function for audit reference numbers
